...
// message.textContent =
//   'We use cookies for improves functionality and analytics.';
message.innerHTML =
  'We use cookies for improves functionality and analytics. <button class = "btn btn--close-cookie">Got it!</button>';
